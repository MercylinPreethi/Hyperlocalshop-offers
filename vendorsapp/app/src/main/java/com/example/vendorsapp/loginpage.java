    ...
    private void loginUser() {
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                vendorRef.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(loginpage.this, "Access denied: Not a vendor account", Toast.LENGTH_LONG).show();
                        }
                    }
